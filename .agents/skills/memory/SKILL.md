...
2. Update `.Codex/memory/project-state.md`:
   - Set "Last Updated" to today's date
   - Fill in Current Feature, Status, What Was Done, Next Steps
   - Add entry to Session History

3. Update `.Codex/memory/decisions.md` if any architectural decisions were made

4. Update `.Codex/memory/patterns.md` if any new patterns were discovered or anti-patterns hit
...
1. Read `.Codex/memory/project-state.md`
2. Read `.Codex/memory/decisions.md` (last 3 entries)
3. Read `.Codex/memory/patterns.md` (established patterns list)
