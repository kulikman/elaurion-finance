...
**Project:** Elurion Finance (`package.json`: `elaurion-finance`)
...
- [x] README and site metadata adapted for this project
...
2. Запустить `pnpm post-clone "ProductName" "product-slug" "https://product.com"` (если проект ещё не персонализирован)
